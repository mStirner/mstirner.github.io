...
jQuery(document).ready(function ($) {
	...
	$('[data-type="modal-trigger"]').on('click', function () {
		...
		let actionBtn = $(this);
		let scaleValue = retrieveScale(actionBtn.next('.cd-modal-bg'));
	...
	function scaleValue(topValue, leftValue, radiusValue, windowW, windowH) {
		...
		let maxDistVert = (topValue > windowH / 2) ? topValue : (windowH - topValue);
	...
	function closeModal() {
		...
		// get active overlay section
		let section = $('.cd-section.modal-is-visible');
